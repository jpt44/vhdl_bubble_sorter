...
HD_PWD='d:/college/masters/winter_2019-20/ecec661/hw4/ip_repo/edit_bubble_sort_ip_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bubble_sort_ip_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bubble_sort_ip_v1_0.tcl
