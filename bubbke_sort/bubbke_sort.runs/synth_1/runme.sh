...
HD_PWD='D:/College/Masters/Winter_2019-20/ECEC661/HW4/bubbke_sort/bubbke_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bubble_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bubble_logic.tcl
