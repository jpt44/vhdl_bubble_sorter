...
HD_PWD='D:/College/Masters/Winter_2019-20/ECEC661/HW4/bubble_sort_tb/bubble_sort_tb.runs/system_bubble_sort_ip_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bubble_sort_ip_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bubble_sort_ip_0_2.tcl
