...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../bubble_sort_tb.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../bubble_sort_tb.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../bubble_sort_tb.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../bubble_sort_tb.srcs/sources_1/bd/system/ipshared/8c62/hdl" \
       +incdir+"../../../../bubble_sort_tb.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
